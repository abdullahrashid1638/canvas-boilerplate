...
strokeFolder.open();
var backgroundFolder = gui.addFolder('Background Color');
...
function animate() {
  ...
  c.strokeStyle = "hsl(\n    ".concat(wave.dynamicColor ? Math.abs(strokeColor.hue * Math.sin(increment)) : strokeColor.hue, ", \n    ").concat(strokeColor.saturation, "%, \n    ").concat(strokeColor.lightness, "%\n  )");
  c.stroke();
